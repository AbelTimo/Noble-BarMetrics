/**
 * Comprehensive Bottle Weight Database
 * Tare weights for common liquor bottles across major brands
 * Based on industry standards and manufacturer specifications
 */

export const BOTTLE_WEIGHTS = [
...
/**
 * Calculate full bottle weight from tare and ABV
 */
export function calculateFullWeight(tareG: number, sizeMl: number, abvPercent: number): number {
...
// Add calculated full weights
export const BOTTLE_WEIGHTS_WITH_FULL = BOTTLE_WEIGHTS.map(bottle => ({
  ...bottle,
